...
const panels = [
  {
    ...
    description: "At the heart of the Montessori philosophy is a deep respect for children as unique individuals. We encourage them to think independently, solve problems creatively, respect themselves and others, learn through hands-on experience, and build confidence naturally.",
  },
  {
    title: "Our Vision",
    icon: Sparkles,
    ...
    <section className="py-24 bg-card relative">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-primary uppercase tracking-widest text-sm font-semibold mb-4 block">Our Foundation</span>
        ...
        >
          {panels.map((panel, index) => (
            <motion.div 
              ...
              className={`p-10 rounded-3xl ${panel.bgColor} border border-white/50 relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300 shadow-sm hover:shadow-md`}
            >
